              ...
              <table className="Tabla-user">
                ...
                <tbody class="thead-user">
                  <tr>
                    ...
                    <th>Activo</th>
                    <th>true</th>
                    <th className="th-btn-garbage">
                      <button className="btn-garbage">
                        <i className="fas fa-trash-alt"></i>
                      </button>
                    </th>
                    <th className="th-btn-garbage">
                      <button className="btn-locked border-quitar ">
          ...
          <div id="zona-addU">
            <div className="container-add-user">
              <div className="table-AddU">
                <div id="inputs-add">
                  <div>
                    <h2 id="h2-add-user">Agregar Usuario</h2>
                  </div>
                ...
                <div id="btn-config-user">
                  <div>
                    <h2 id="h2-type-user">Tipo de usuario</h2>
                  </div>
                  <div className="table-AddU " id="btnA">
                    <div className="div-btn-ajust-AdorTu">
                      {" "}
                      <button className="btn-ajust-AdorTu">
                        <h2>Admi</h2>
                      </button>
                    </div>
                    <div className="div-btn-ajust-AdorTu">
                  ...
                  <div id="div-agregar-user">
                    <button id="btn-agregar-user">
                      <h2 id="h2-btn-agregar-user">Agregar</h2>
                    </button>
                  </div>
                </div>
              </div>
